...
var px_simple_horizontal_bar_chart;
...
function runBaseTests() {
  px_simple_horizontal_bar_chart = document.getElementById('fixture1');

  suite('Base Automation Tests for px-simple-horizontal-bar-chart', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-simple-horizontal-bar-chart fixture is created', function() {
      assert.isTrue(document.getElementById('fixture1') !== null);
    });
